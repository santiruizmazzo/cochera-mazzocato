...
func (api TestingAPI) UpdateTenant(tenantID int, tenant any) (*http.Response, error) {
...
func (api TestingAPI) GetSlots() (*http.Response, error) {
	return http.Get(api.GetSlotsRoute())
}
...
func (api TestingAPI) UpdateSlot(slotID int, slot any) (*http.Response, error) {
	...
	return utils.HTTPPatch(fullEndpointURL, "application/json", bytes.NewBuffer(jsonSlot))
}
